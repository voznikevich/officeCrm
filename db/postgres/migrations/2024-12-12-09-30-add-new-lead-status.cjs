module.exports = {
    up: async (queryInterface) => {
        await queryInterface.sequelize.query(`
            ALTER TYPE "enum_Leads_status" ADD VALUE 'initial call';
        `);

        await queryInterface.sequelize.query(`
            ALTER TYPE "enum_Leads_status" ADD VALUE 'wrong info';
        `);

        await queryInterface.sequelize.query(`
            ALTER TYPE "enum_Leads_status" ADD VALUE 'invalid language';
        `);
    },
